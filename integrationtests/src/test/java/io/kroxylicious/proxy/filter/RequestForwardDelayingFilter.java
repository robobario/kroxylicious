...
public class RequestForwardDelayingFilter implements RequestFilter {
    ...
    public CompletionStage<? extends FilterResult> onRequest(ApiKeys apiKey, RequestHeaderData header, ApiMessage body, KrpcFilterContext filterContext) {
        CompletableFuture<FilterResult> future = new CompletableFuture<>();
        FilterResultBuilder<RequestFilterResult, RequestHeaderData> builder = filterContext.requestFilterResultBuilder();
