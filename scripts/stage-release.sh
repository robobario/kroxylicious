...
mvn -Prelease,dist -DskipTests=true -DskipDocs=true -DskipKTs=true -DskipDocker=true -DreleaseSigningKey="${GPG_KEY}" -DprocessAllModules=true deploy | tee ${MVN_DEPLOY_OUTPUT}
