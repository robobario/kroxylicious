...
record SafeInvoker(FilterInvoker invoker) implements FilterInvoker {
    ...
    @Override
    public CompletionStage<RequestFilterResult<ApiMessage>> onRequest(ApiKeys apiKey, short apiVersion, RequestHeaderData header, ApiMessage body, KrpcFilterContext<ApiMessage> filterContext) {
    ...
    @Override
    public CompletionStage<ResponseFilterResult<ApiMessage>> onResponse(ApiKeys apiKey, short apiVersion, ResponseHeaderData header, ApiMessage body, KrpcFilterContext<ApiMessage> filterContext) {
