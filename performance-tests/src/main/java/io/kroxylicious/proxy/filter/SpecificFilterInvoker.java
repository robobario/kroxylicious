...
public class SpecificFilterInvoker implements FilterInvoker {
    ...
    public CompletionStage<RequestFilterResult<ApiMessage>> onRequest(ApiKeys apiKey,
        ...
        return switch (apiKey) {
            case ADD_OFFSETS_TO_TXN ->
                ((AddOffsetsToTxnRequestFilter) filter)
                        .onAddOffsetsToTxnRequest(apiVersion, header, (AddOffsetsToTxnRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ADD_PARTITIONS_TO_TXN ->
                ((AddPartitionsToTxnRequestFilter) filter)
                        .onAddPartitionsToTxnRequest(apiVersion, header, (AddPartitionsToTxnRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ALLOCATE_PRODUCER_IDS ->
                ((AllocateProducerIdsRequestFilter) filter)
                        .onAllocateProducerIdsRequest(apiVersion, header, (AllocateProducerIdsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ALTER_CLIENT_QUOTAS ->
                ((AlterClientQuotasRequestFilter) filter)
                        .onAlterClientQuotasRequest(apiVersion, header, (AlterClientQuotasRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ALTER_CONFIGS ->
                ((AlterConfigsRequestFilter) filter)
                        .onAlterConfigsRequest(apiVersion, header, (AlterConfigsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ALTER_PARTITION_REASSIGNMENTS -> ((AlterPartitionReassignmentsRequestFilter) filter).onAlterPartitionReassignmentsRequest(apiVersion, header,
                    (AlterPartitionReassignmentsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext)).thenApply(RequestFilterResult::asApiMessageResult);
            case ALTER_PARTITION -> ((AlterPartitionRequestFilter) filter)
                    .onAlterPartitionRequest(apiVersion, header, (AlterPartitionRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case ALTER_REPLICA_LOG_DIRS ->
                ((AlterReplicaLogDirsRequestFilter) filter)
                        .onAlterReplicaLogDirsRequest(apiVersion, header, (AlterReplicaLogDirsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ALTER_USER_SCRAM_CREDENTIALS ->
                ((AlterUserScramCredentialsRequestFilter) filter).onAlterUserScramCredentialsRequest(apiVersion, header, (AlterUserScramCredentialsRequestData) body,
                        KrpcFilterContext.toSpecificContext(filterContext)).thenApply(RequestFilterResult::asApiMessageResult);
            case API_VERSIONS ->
                ((ApiVersionsRequestFilter) filter)
                        .onApiVersionsRequest(apiVersion, header, (ApiVersionsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case BEGIN_QUORUM_EPOCH ->
                ((BeginQuorumEpochRequestFilter) filter)
                        .onBeginQuorumEpochRequest(apiVersion, header, (BeginQuorumEpochRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case BROKER_HEARTBEAT ->
                ((BrokerHeartbeatRequestFilter) filter)
                        .onBrokerHeartbeatRequest(apiVersion, header, (BrokerHeartbeatRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case BROKER_REGISTRATION ->
                ((BrokerRegistrationRequestFilter) filter)
                        .onBrokerRegistrationRequest(apiVersion, header, (BrokerRegistrationRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case CONTROLLED_SHUTDOWN ->
                ((ControlledShutdownRequestFilter) filter)
                        .onControlledShutdownRequest(apiVersion, header, (ControlledShutdownRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case CREATE_ACLS ->
                ((CreateAclsRequestFilter) filter)
                        .onCreateAclsRequest(apiVersion, header, (CreateAclsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case CREATE_DELEGATION_TOKEN ->
                ((CreateDelegationTokenRequestFilter) filter)
                        .onCreateDelegationTokenRequest(apiVersion, header, (CreateDelegationTokenRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case CREATE_PARTITIONS ->
                ((CreatePartitionsRequestFilter) filter)
                        .onCreatePartitionsRequest(apiVersion, header, (CreatePartitionsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case CREATE_TOPICS ->
                ((CreateTopicsRequestFilter) filter)
                        .onCreateTopicsRequest(apiVersion, header, (CreateTopicsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DELETE_ACLS ->
                ((DeleteAclsRequestFilter) filter)
                        .onDeleteAclsRequest(apiVersion, header, (DeleteAclsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DELETE_GROUPS ->
                ((DeleteGroupsRequestFilter) filter)
                        .onDeleteGroupsRequest(apiVersion, header, (DeleteGroupsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DELETE_RECORDS -> ((DeleteRecordsRequestFilter) filter)
                    .onDeleteRecordsRequest(apiVersion, header, (DeleteRecordsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case DELETE_TOPICS ->
                ((DeleteTopicsRequestFilter) filter)
                        .onDeleteTopicsRequest(apiVersion, header, (DeleteTopicsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_ACLS ->
                ((DescribeAclsRequestFilter) filter)
                        .onDescribeAclsRequest(apiVersion, header, (DescribeAclsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_CLIENT_QUOTAS ->
                ((DescribeClientQuotasRequestFilter) filter)
                        .onDescribeClientQuotasRequest(apiVersion, header, (DescribeClientQuotasRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_CLUSTER ->
                ((DescribeClusterRequestFilter) filter)
                        .onDescribeClusterRequest(apiVersion, header, (DescribeClusterRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_CONFIGS ->
                ((DescribeConfigsRequestFilter) filter)
                        .onDescribeConfigsRequest(apiVersion, header, (DescribeConfigsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_DELEGATION_TOKEN ->
                ((DescribeDelegationTokenRequestFilter) filter).onDescribeDelegationTokenRequest(apiVersion, header, (DescribeDelegationTokenRequestData) body,
                        KrpcFilterContext.toSpecificContext(filterContext)).thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_GROUPS -> ((DescribeGroupsRequestFilter) filter)
                    .onDescribeGroupsRequest(apiVersion, header, (DescribeGroupsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_LOG_DIRS ->
                ((DescribeLogDirsRequestFilter) filter)
                        .onDescribeLogDirsRequest(apiVersion, header, (DescribeLogDirsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_PRODUCERS ->
                ((DescribeProducersRequestFilter) filter)
                        .onDescribeProducersRequest(apiVersion, header, (DescribeProducersRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_QUORUM -> ((DescribeQuorumRequestFilter) filter)
                    .onDescribeQuorumRequest(apiVersion, header, (DescribeQuorumRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_TRANSACTIONS ->
                ((DescribeTransactionsRequestFilter) filter)
                        .onDescribeTransactionsRequest(apiVersion, header, (DescribeTransactionsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case DESCRIBE_USER_SCRAM_CREDENTIALS -> ((DescribeUserScramCredentialsRequestFilter) filter).onDescribeUserScramCredentialsRequest(apiVersion, header,
                    (DescribeUserScramCredentialsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case ELECT_LEADERS ->
                ((ElectLeadersRequestFilter) filter)
                        .onElectLeadersRequest(apiVersion, header, (ElectLeadersRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case END_QUORUM_EPOCH -> ((EndQuorumEpochRequestFilter) filter)
                    .onEndQuorumEpochRequest(apiVersion, header, (EndQuorumEpochRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case END_TXN ->
                ((EndTxnRequestFilter) filter).onEndTxnRequest(apiVersion, header, (EndTxnRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case ENVELOPE ->
                ((EnvelopeRequestFilter) filter).onEnvelopeRequest(apiVersion, header, (EnvelopeRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case EXPIRE_DELEGATION_TOKEN ->
                ((ExpireDelegationTokenRequestFilter) filter)
                        .onExpireDelegationTokenRequest(apiVersion, header, (ExpireDelegationTokenRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case FETCH -> ((FetchRequestFilter) filter).onFetchRequest(apiVersion, header, (FetchRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case FETCH_SNAPSHOT -> ((FetchSnapshotRequestFilter) filter)
                    .onFetchSnapshotRequest(apiVersion, header, (FetchSnapshotRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case FIND_COORDINATOR ->
                ((FindCoordinatorRequestFilter) filter)
                        .onFindCoordinatorRequest(apiVersion, header, (FindCoordinatorRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case HEARTBEAT ->
                ((HeartbeatRequestFilter) filter).onHeartbeatRequest(apiVersion, header, (HeartbeatRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case INCREMENTAL_ALTER_CONFIGS ->
                ((IncrementalAlterConfigsRequestFilter) filter).onIncrementalAlterConfigsRequest(apiVersion, header, (IncrementalAlterConfigsRequestData) body,
                        KrpcFilterContext.toSpecificContext(filterContext)).thenApply(RequestFilterResult::asApiMessageResult);
            case INIT_PRODUCER_ID -> ((InitProducerIdRequestFilter) filter)
                    .onInitProducerIdRequest(apiVersion, header, (InitProducerIdRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case JOIN_GROUP ->
                ((JoinGroupRequestFilter) filter).onJoinGroupRequest(apiVersion, header, (JoinGroupRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case LEADER_AND_ISR ->
                ((LeaderAndIsrRequestFilter) filter)
                        .onLeaderAndIsrRequest(apiVersion, header, (LeaderAndIsrRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case LEAVE_GROUP ->
                ((LeaveGroupRequestFilter) filter)
                        .onLeaveGroupRequest(apiVersion, header, (LeaveGroupRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case LIST_GROUPS ->
                ((ListGroupsRequestFilter) filter)
                        .onListGroupsRequest(apiVersion, header, (ListGroupsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case LIST_OFFSETS ->
                ((ListOffsetsRequestFilter) filter)
                        .onListOffsetsRequest(apiVersion, header, (ListOffsetsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case LIST_PARTITION_REASSIGNMENTS -> ((ListPartitionReassignmentsRequestFilter) filter).onListPartitionReassignmentsRequest(apiVersion, header,
                    (ListPartitionReassignmentsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext)).thenApply(RequestFilterResult::asApiMessageResult);
            case LIST_TRANSACTIONS ->
                ((ListTransactionsRequestFilter) filter)
                        .onListTransactionsRequest(apiVersion, header, (ListTransactionsRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case METADATA ->
                ((MetadataRequestFilter) filter).onMetadataRequest(apiVersion, header, (MetadataRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case OFFSET_COMMIT ->
                ((OffsetCommitRequestFilter) filter)
                        .onOffsetCommitRequest(apiVersion, header, (OffsetCommitRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case OFFSET_DELETE ->
                ((OffsetDeleteRequestFilter) filter)
                        .onOffsetDeleteRequest(apiVersion, header, (OffsetDeleteRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case OFFSET_FETCH ->
                ((OffsetFetchRequestFilter) filter)
                        .onOffsetFetchRequest(apiVersion, header, (OffsetFetchRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case OFFSET_FOR_LEADER_EPOCH ->
                ((OffsetForLeaderEpochRequestFilter) filter)
                        .onOffsetForLeaderEpochRequest(apiVersion, header, (OffsetForLeaderEpochRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case PRODUCE ->
                ((ProduceRequestFilter) filter).onProduceRequest(apiVersion, header, (ProduceRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case RENEW_DELEGATION_TOKEN ->
                ((RenewDelegationTokenRequestFilter) filter)
                        .onRenewDelegationTokenRequest(apiVersion, header, (RenewDelegationTokenRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case SASL_AUTHENTICATE ->
                ((SaslAuthenticateRequestFilter) filter)
                        .onSaslAuthenticateRequest(apiVersion, header, (SaslAuthenticateRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case SASL_HANDSHAKE -> ((SaslHandshakeRequestFilter) filter)
                    .onSaslHandshakeRequest(apiVersion, header, (SaslHandshakeRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case STOP_REPLICA ->
                ((StopReplicaRequestFilter) filter)
                        .onStopReplicaRequest(apiVersion, header, (StopReplicaRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case SYNC_GROUP ->
                ((SyncGroupRequestFilter) filter).onSyncGroupRequest(apiVersion, header, (SyncGroupRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case TXN_OFFSET_COMMIT ->
                ((TxnOffsetCommitRequestFilter) filter)
                        .onTxnOffsetCommitRequest(apiVersion, header, (TxnOffsetCommitRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case UNREGISTER_BROKER ->
                ((UnregisterBrokerRequestFilter) filter)
                        .onUnregisterBrokerRequest(apiVersion, header, (UnregisterBrokerRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
            case UPDATE_FEATURES -> ((UpdateFeaturesRequestFilter) filter)
                    .onUpdateFeaturesRequest(apiVersion, header, (UpdateFeaturesRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case UPDATE_METADATA -> ((UpdateMetadataRequestFilter) filter)
                    .onUpdateMetadataRequest(apiVersion, header, (UpdateMetadataRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case VOTE -> ((VoteRequestFilter) filter).onVoteRequest(apiVersion, header, (VoteRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(RequestFilterResult::asApiMessageResult);
            case WRITE_TXN_MARKERS ->
                ((WriteTxnMarkersRequestFilter) filter)
                        .onWriteTxnMarkersRequest(apiVersion, header, (WriteTxnMarkersRequestData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(RequestFilterResult::asApiMessageResult);
    ...
    public CompletionStage<ResponseFilterResult<ApiMessage>> onResponse(ApiKeys apiKey,
        ...
        return switch (apiKey) {
            case ADD_OFFSETS_TO_TXN ->
                ((AddOffsetsToTxnResponseFilter) filter)
                        .onAddOffsetsToTxnResponse(apiVersion, header, (AddOffsetsToTxnResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ADD_PARTITIONS_TO_TXN ->
                ((AddPartitionsToTxnResponseFilter) filter)
                        .onAddPartitionsToTxnResponse(apiVersion, header, (AddPartitionsToTxnResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALLOCATE_PRODUCER_IDS ->
                ((AllocateProducerIdsResponseFilter) filter)
                        .onAllocateProducerIdsResponse(apiVersion, header, (AllocateProducerIdsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALTER_CLIENT_QUOTAS ->
                ((AlterClientQuotasResponseFilter) filter)
                        .onAlterClientQuotasResponse(apiVersion, header, (AlterClientQuotasResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALTER_CONFIGS -> ((AlterConfigsResponseFilter) filter)
                    .onAlterConfigsResponse(apiVersion, header, (AlterConfigsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALTER_PARTITION_REASSIGNMENTS -> ((AlterPartitionReassignmentsResponseFilter) filter).onAlterPartitionReassignmentsResponse(apiVersion, header,
                    (AlterPartitionReassignmentsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALTER_PARTITION ->
                ((AlterPartitionResponseFilter) filter)
                        .onAlterPartitionResponse(apiVersion, header, (AlterPartitionResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALTER_REPLICA_LOG_DIRS ->
                ((AlterReplicaLogDirsResponseFilter) filter)
                        .onAlterReplicaLogDirsResponse(apiVersion, header, (AlterReplicaLogDirsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ALTER_USER_SCRAM_CREDENTIALS -> ((AlterUserScramCredentialsResponseFilter) filter).onAlterUserScramCredentialsResponse(apiVersion, header,
                    (AlterUserScramCredentialsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext)).thenApply(ResponseFilterResult::asApiMessageResult);
            case API_VERSIONS ->
                ((ApiVersionsResponseFilter) filter)
                        .onApiVersionsResponse(apiVersion, header, (ApiVersionsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case BEGIN_QUORUM_EPOCH ->
                ((BeginQuorumEpochResponseFilter) filter)
                        .onBeginQuorumEpochResponse(apiVersion, header, (BeginQuorumEpochResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case BROKER_HEARTBEAT ->
                ((BrokerHeartbeatResponseFilter) filter)
                        .onBrokerHeartbeatResponse(apiVersion, header, (BrokerHeartbeatResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case BROKER_REGISTRATION ->
                ((BrokerRegistrationResponseFilter) filter)
                        .onBrokerRegistrationResponse(apiVersion, header, (BrokerRegistrationResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case CONTROLLED_SHUTDOWN ->
                ((ControlledShutdownResponseFilter) filter)
                        .onControlledShutdownResponse(apiVersion, header, (ControlledShutdownResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case CREATE_ACLS ->
                ((CreateAclsResponseFilter) filter)
                        .onCreateAclsResponse(apiVersion, header, (CreateAclsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case CREATE_DELEGATION_TOKEN ->
                ((CreateDelegationTokenResponseFilter) filter).onCreateDelegationTokenResponse(apiVersion, header, (CreateDelegationTokenResponseData) body,
                        KrpcFilterContext.toSpecificContext(filterContext)).thenApply(ResponseFilterResult::asApiMessageResult);
            case CREATE_PARTITIONS ->
                ((CreatePartitionsResponseFilter) filter)
                        .onCreatePartitionsResponse(apiVersion, header, (CreatePartitionsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case CREATE_TOPICS -> ((CreateTopicsResponseFilter) filter)
                    .onCreateTopicsResponse(apiVersion, header, (CreateTopicsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case DELETE_ACLS ->
                ((DeleteAclsResponseFilter) filter)
                        .onDeleteAclsResponse(apiVersion, header, (DeleteAclsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DELETE_GROUPS -> ((DeleteGroupsResponseFilter) filter)
                    .onDeleteGroupsResponse(apiVersion, header, (DeleteGroupsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case DELETE_RECORDS -> ((DeleteRecordsResponseFilter) filter)
                    .onDeleteRecordsResponse(apiVersion, header, (DeleteRecordsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case DELETE_TOPICS -> ((DeleteTopicsResponseFilter) filter)
                    .onDeleteTopicsResponse(apiVersion, header, (DeleteTopicsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_ACLS -> ((DescribeAclsResponseFilter) filter)
                    .onDescribeAclsResponse(apiVersion, header, (DescribeAclsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_CLIENT_QUOTAS ->
                ((DescribeClientQuotasResponseFilter) filter)
                        .onDescribeClientQuotasResponse(apiVersion, header, (DescribeClientQuotasResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_CLUSTER ->
                ((DescribeClusterResponseFilter) filter)
                        .onDescribeClusterResponse(apiVersion, header, (DescribeClusterResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_CONFIGS ->
                ((DescribeConfigsResponseFilter) filter)
                        .onDescribeConfigsResponse(apiVersion, header, (DescribeConfigsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_DELEGATION_TOKEN ->
            ...
            case DESCRIBE_GROUPS ->
                ((DescribeGroupsResponseFilter) filter)
                        .onDescribeGroupsResponse(apiVersion, header, (DescribeGroupsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_LOG_DIRS ->
                ((DescribeLogDirsResponseFilter) filter)
                        .onDescribeLogDirsResponse(apiVersion, header, (DescribeLogDirsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_PRODUCERS ->
                ((DescribeProducersResponseFilter) filter)
                        .onDescribeProducersResponse(apiVersion, header, (DescribeProducersResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_QUORUM ->
                ((DescribeQuorumResponseFilter) filter)
                        .onDescribeQuorumResponse(apiVersion, header, (DescribeQuorumResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_TRANSACTIONS ->
                ((DescribeTransactionsResponseFilter) filter)
                        .onDescribeTransactionsResponse(apiVersion, header, (DescribeTransactionsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case DESCRIBE_USER_SCRAM_CREDENTIALS -> ((DescribeUserScramCredentialsResponseFilter) filter).onDescribeUserScramCredentialsResponse(apiVersion, header,
                    (DescribeUserScramCredentialsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case ELECT_LEADERS -> ((ElectLeadersResponseFilter) filter)
                    .onElectLeadersResponse(apiVersion, header, (ElectLeadersResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case END_QUORUM_EPOCH ->
                ((EndQuorumEpochResponseFilter) filter)
                        .onEndQuorumEpochResponse(apiVersion, header, (EndQuorumEpochResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case END_TXN ->
                ((EndTxnResponseFilter) filter).onEndTxnResponse(apiVersion, header, (EndTxnResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case ENVELOPE ->
                ((EnvelopeResponseFilter) filter).onEnvelopeResponse(apiVersion, header, (EnvelopeResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case EXPIRE_DELEGATION_TOKEN ->
                ((ExpireDelegationTokenResponseFilter) filter).onExpireDelegationTokenResponse(apiVersion, header, (ExpireDelegationTokenResponseData) body,
                        KrpcFilterContext.toSpecificContext(filterContext)).thenApply(ResponseFilterResult::asApiMessageResult);
            case FETCH -> ((FetchResponseFilter) filter).onFetchResponse(apiVersion, header, (FetchResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case FETCH_SNAPSHOT -> ((FetchSnapshotResponseFilter) filter)
                    .onFetchSnapshotResponse(apiVersion, header, (FetchSnapshotResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case FIND_COORDINATOR ->
                ((FindCoordinatorResponseFilter) filter)
                        .onFindCoordinatorResponse(apiVersion, header, (FindCoordinatorResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case HEARTBEAT ->
                ((HeartbeatResponseFilter) filter)
                        .onHeartbeatResponse(apiVersion, header, (HeartbeatResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case INCREMENTAL_ALTER_CONFIGS ->
            ...
            case INIT_PRODUCER_ID ->
                ((InitProducerIdResponseFilter) filter)
                        .onInitProducerIdResponse(apiVersion, header, (InitProducerIdResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case JOIN_GROUP ->
                ((JoinGroupResponseFilter) filter)
                        .onJoinGroupResponse(apiVersion, header, (JoinGroupResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case LEADER_AND_ISR -> ((LeaderAndIsrResponseFilter) filter)
                    .onLeaderAndIsrResponse(apiVersion, header, (LeaderAndIsrResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case LEAVE_GROUP ->
                ((LeaveGroupResponseFilter) filter)
                        .onLeaveGroupResponse(apiVersion, header, (LeaveGroupResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case LIST_GROUPS ->
                ((ListGroupsResponseFilter) filter)
                        .onListGroupsResponse(apiVersion, header, (ListGroupsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case LIST_OFFSETS ->
                ((ListOffsetsResponseFilter) filter)
                        .onListOffsetsResponse(apiVersion, header, (ListOffsetsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case LIST_PARTITION_REASSIGNMENTS -> ((ListPartitionReassignmentsResponseFilter) filter).onListPartitionReassignmentsResponse(apiVersion, header,
                    (ListPartitionReassignmentsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case LIST_TRANSACTIONS ->
                ((ListTransactionsResponseFilter) filter)
                        .onListTransactionsResponse(apiVersion, header, (ListTransactionsResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case METADATA ->
                ((MetadataResponseFilter) filter).onMetadataResponse(apiVersion, header, (MetadataResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case OFFSET_COMMIT -> ((OffsetCommitResponseFilter) filter)
                    .onOffsetCommitResponse(apiVersion, header, (OffsetCommitResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case OFFSET_DELETE -> ((OffsetDeleteResponseFilter) filter)
                    .onOffsetDeleteResponse(apiVersion, header, (OffsetDeleteResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case OFFSET_FETCH ->
                ((OffsetFetchResponseFilter) filter)
                        .onOffsetFetchResponse(apiVersion, header, (OffsetFetchResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case OFFSET_FOR_LEADER_EPOCH ->
                ((OffsetForLeaderEpochResponseFilter) filter)
                        .onOffsetForLeaderEpochResponse(apiVersion, header, (OffsetForLeaderEpochResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case PRODUCE ->
                ((ProduceResponseFilter) filter).onProduceResponse(apiVersion, header, (ProduceResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case RENEW_DELEGATION_TOKEN ->
                ((RenewDelegationTokenResponseFilter) filter)
                        .onRenewDelegationTokenResponse(apiVersion, header, (RenewDelegationTokenResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case SASL_AUTHENTICATE ->
                ((SaslAuthenticateResponseFilter) filter)
                        .onSaslAuthenticateResponse(apiVersion, header, (SaslAuthenticateResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case SASL_HANDSHAKE -> ((SaslHandshakeResponseFilter) filter)
                    .onSaslHandshakeResponse(apiVersion, header, (SaslHandshakeResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case STOP_REPLICA ->
                ((StopReplicaResponseFilter) filter)
                        .onStopReplicaResponse(apiVersion, header, (StopReplicaResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case SYNC_GROUP ->
                ((SyncGroupResponseFilter) filter)
                        .onSyncGroupResponse(apiVersion, header, (SyncGroupResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case TXN_OFFSET_COMMIT ->
                ((TxnOffsetCommitResponseFilter) filter)
                        .onTxnOffsetCommitResponse(apiVersion, header, (TxnOffsetCommitResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case UNREGISTER_BROKER ->
                ((UnregisterBrokerResponseFilter) filter)
                        .onUnregisterBrokerResponse(apiVersion, header, (UnregisterBrokerResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case UPDATE_FEATURES ->
                ((UpdateFeaturesResponseFilter) filter)
                        .onUpdateFeaturesResponse(apiVersion, header, (UpdateFeaturesResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case UPDATE_METADATA ->
                ((UpdateMetadataResponseFilter) filter)
                        .onUpdateMetadataResponse(apiVersion, header, (UpdateMetadataResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            case VOTE -> ((VoteResponseFilter) filter).onVoteResponse(apiVersion, header, (VoteResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                    .thenApply(ResponseFilterResult::asApiMessageResult);
            case WRITE_TXN_MARKERS ->
                ((WriteTxnMarkersResponseFilter) filter)
                        .onWriteTxnMarkersResponse(apiVersion, header, (WriteTxnMarkersResponseData) body, KrpcFilterContext.toSpecificContext(filterContext))
                        .thenApply(ResponseFilterResult::asApiMessageResult);
            default -> throw new IllegalStateException("Unsupported RPC " + apiKey);
        };
    }
