...
import static io.kroxylicious.net.IntegrationTestInetAddressResolverProvider.TEST_DOMAINS;
        ...
        try (var tester = kroxyliciousTester(builder)) {
            for (int i = 0; i < numberOfVirtualClusters; i++) {
                ...
                try (var admin = tester.admin(clusterName, Map.of(
                    ...
                    String expectedAdvertisedBrokerHost = "broker-0.%s%s".formatted(clusterName, TEST_DOMAINS);
